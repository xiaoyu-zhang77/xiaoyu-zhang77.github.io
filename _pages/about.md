...
我是广东工业大学工业设计工程专业的一名研一学生。目前正在学习 Gitee 应用开发相关课程.这是我第一次从零开始搭建属于自己的个人网站，也是一次将理论知识转化为实践成果的尝试。
在这里，我将记录自己的学习历程、项目实践、设计思考以及未来的探索方向。未来我也会持续分享在工业设计、产品开发以及数字化设计领域的学习心得与作品。
